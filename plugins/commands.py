...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            pass
        return await message.reply(f"**<b>⚡️ ʜᴀᴘᴘʏ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴀɴᴅ ᴄᴏᴍᴇ ᴀɢᴀɪɴ 🌼</b>**")
    files = files_[0]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥 Oᴜʀ Gʀᴏᴜᴘ 🔥', url=f"https://t.me/hd_request") ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
