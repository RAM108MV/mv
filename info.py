...
BOT_TOKEN = environ.get('BOT_TOKEN', "6220664380:AAHeSY8HsEFqxxgimb1ztgQScj1fWFq8pZk")
...
auth_channel = environ.get('-1001784080940')
...
MONGO_URL = os.environ.get('MONGO_URL', "mongodb+srv://newbot:newbot@cluster0.6qrhqjw.mongodb.net/?retryWrites=true&w=majority")
...
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/+-FcngP9amJ9jYjA1")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+-FcngP9amJ9jYjA1")
MSG_ALRT = environ.get('MSG_ALRT', 'ᴛʀʏ ᴍʏ ᴀʟʟ ғᴜᴛᴜʀᴇꜱ 🪷')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '0'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001557416007'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'hd_request')
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "Truse")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.CUSTOM_FILE_CAPTION}")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "📝 ꜰɪʟᴇ ɴᴀᴍᴇ:- {file_name}\n\n🔅 sɪᴢᴇ:- {file_size}\n\n⚡️ ʜᴀᴘᴘʏ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴀɴᴅ ᴄᴏᴍᴇ ᴀɢᴀɪɴ 🌼")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", f"{script.IMDB_TEMPLATE_TXT}")
LONG_IMDB_DESCRIPTION = is_enabled(environ.get("LONG_IMDB_DESCRIPTION", "False"), False)
SPELL_CHECK_REPLY = is_enabled(environ.get("SPELL_CHECK_REPLY", "True"), True)
MAX_LIST_ELM = environ.get("MAX_LIST_ELM", None)
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001530594023 -1001714499165 -1001820791987 -1001940024711')).split()]
